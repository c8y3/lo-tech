...
describe('fragments.CodeGenerator', function() {
    ...
    describe('generate', function() {
        ...
        it('should return a constructor of the node', function() {
            ...
            assert.equal(result[0], 'const result = lotech.Component(lotech.createElement(\'p\', {}, []));');
        });
        ...
        it('should append children', function() {
            ...
            assert.equal(result[0], 'const result = lotech.Component(lotech.createElement(\'div\', {}, [...children]));');
        });

        it('should set attributes', function() {
            const result = subject.generate({type: 'element', tagName: 'div', attributes: {class: 'root'}, children: []});
            assert.equal(result[0], 'const result = lotech.Component(lotech.createElement(\'div\', {\'class\': "root"}, []));');
        });
        ...
        it('should pass the constructor when the tag name is upper case', function() {
            ...
            assert.equal(result[0], 'const result = lotech.Component(lotech.createElement(Row, {}, []));');
        });
        ...
        it('should set style as an array', function() {
            ...
            assert.equal(result[0], 'const result = lotech.Component(lotech.createElement(\'div\', {\'style\': ["root"]}, []));');
        });
        ...
        it('should set style as an array of several elements when there is a spec', function() {
            ...
            assert.equal(result[0], 'const result = lotech.Component(lotech.createElement(\'div\', {\'style\': ["root","selected"]}, []));');
        });
        ...
        it('should separate attributes with semicolon', function() {
            ...
            assert.equal(result[0], 'const result = lotech.Component(lotech.createElement(\'div\', {\'scope\': "Row", \'style\': ["root"]}, []));');            
        });
